        ...
        {  
            ...
            {  
              ...
              {  
                ...
                metaObject = parameterMap == null ? null : MetaObject.forObject(parameterObject, MetaObject.DEFAULT_OBJECT_FACTORY, MetaObject.DEFAULT_OBJECT_WRAPPER_FACTORY);  
                ...
                {  
                  ...
                  if (value != null) 
                  {  
                    value = MetaObject.forObject(value,MetaObject.DEFAULT_OBJECT_FACTORY, MetaObject.DEFAULT_OBJECT_WRAPPER_FACTORY).getValue(propertyName.substring(prop.getName().length()));  
                  }  
                } 
                else 
                {  
