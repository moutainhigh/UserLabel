    ...
    $(document).ready(function() {
		...
		getCountryBroadNatural();
			
	});
    
    
    function getCountryBroadNatural(){
    	var flag = "1";
		//var flag1 = "2";
		...
		$.ajax({
			...
			success : function(data) {
				...
				if (data.flag) {
					//存量不限量产品办理量
					var AllCountryMobile = data.result.AllCountryBroadNature;
					chartScene2(AllCountryMobile,data.msg);
    ...
    function chartScene2(result,msg){
    	var myFileChart2 = echarts.init(document
				.getElementById('chart_broad'));
		// 显示标题，图例和空的坐标轴
